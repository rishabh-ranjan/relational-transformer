...
:class:`~expts.repaper_baselines.rel2tab.model.Rel2TabModel`, which plugs into
...
time via :class:`~expts.repaper_baselines.rel2tab.precomputed.PrecomputedFeaturizer`.
"""
