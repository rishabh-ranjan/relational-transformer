...
def main(
    *,
    ...
    if method == "rt":
        ...
        from expts.repaper_baselines.rel2tab.model import Rel2TabModel
        from expts.repaper_baselines.rel2tab.precomputed import PrecomputedFeaturizer
        ...
        if method.endswith("_tabicl"):
            ...
            from expts.repaper_baselines.rel2tab.lgbm import LGBMPredictor
