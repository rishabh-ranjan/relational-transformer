...
LOG_ROOT = f"{LOG_ROOT}/repaper/scaling"
...
def cpu_resources(db: str) -> Resources:
    # Zero-GPU slots on the il partition (see baselines/submit.py for
...
if __name__ == "__main__":
    ...
    # 3. After the sql / rdblearn feature blobs exist (baselines):
