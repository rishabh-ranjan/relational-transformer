...
## Full test-set eval (pending)

Job 99942 (`eval-b200.sh`): rt.cli.eval at default batch size
(tokens_per_gpu=2^18, bs=32 @ ctx 8192) under both walk configs, RT-J
classification checkpoint on {rel-f1/driver-dnf, rel-f1/driver-top3,
rel-event/user-ignore, rel-event/user-repeat, rel-trial/study-outcome} and
regression checkpoint on {rel-f1/driver-position, rel-event/user-attendance,
rel-trial/site-success, rel-trial/study-adverse}.
